...
AFPSMultiplayerTestProjectile::AFPSMultiplayerTestProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AFPSMultiplayerTestProjectile::OnHit);		// set up a notification for when this component hits something blocking
